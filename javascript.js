...
function createCanvas(gridSize) {
    for (let i=1; i<gridSize+1; i++) {
        ...
        for (let j=1; j<gridSize+1; j++) {  
            ...
            square.setAttribute('style',`height:${960/gridSize}px;width:${960/gridSize}px;background-color:red; border: 1px solid black`);
...
createCanvas(16);
resetButton.onclick = function() {resetCanvas()};
